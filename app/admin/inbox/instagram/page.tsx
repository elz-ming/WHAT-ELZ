    ...
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-2xl bg-pink-50 flex items-center justify-center">
          <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7" stroke="#C13584" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round">
        ...
        <div>
          <h1 className="text-2xl font-bold text-zinc-900">Instagram</h1>
